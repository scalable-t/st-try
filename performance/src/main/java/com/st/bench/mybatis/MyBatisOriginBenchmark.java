...
import com.st.bench.mybatis.mapper.DemoTableOriginMapper;
...
public class MyBatisOriginBenchmark {
    ...
    public void init() {
        ...
        mapper = springContext.getBean(DemoTableOriginMapper.class);
        mapper.truncate();
    }
